                      ...
                      <td className="py-3">
                        {ts.status === 'Pending' && (
                          <div className="flex gap-1">
                            <Button size="sm" variant="ghost" className="h-7 w-7 text-emerald-600" disabled={actionId === ts.id} onClick={() => handleApproval(ts.id, 'Approved')}>
                              <Check className="h-4 w-4" />
                            </Button>
                            <Button size="sm" variant="ghost" className="h-7 w-7 text-red-500" disabled={actionId === ts.id} onClick={() => handleApproval(ts.id, 'Rejected')}>
                              <X className="h-4 w-4" />
                            </Button>
                          </div>
                        )}
