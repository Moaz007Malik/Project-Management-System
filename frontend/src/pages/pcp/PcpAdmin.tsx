                      ...
                      <tr key={c.id} className="border-b border-border/60">
                        ...
                        <td className="py-3">
                          <div className="flex gap-1">
                            <Button size="icon" variant="ghost" className="h-8 w-8" onClick={() => { setEditingChainId(c.id); setChainForm(c) }}>
                              <Pencil className="h-4 w-4" />
                            </Button>
                            <Button size="icon" variant="ghost" className="h-8 w-8 text-primary" onClick={() => void deleteChain(c.id)}>
                  ...
                  <li key={`${item}-${i}`} className="flex items-center justify-between gap-2 px-3 py-2 text-sm">
                    {editIndex === i && canEditMasterInline ? (
                      ...
                      <>
                        ...
                        <div className="flex gap-1">
                          {canEditMasterInline && (
                            <Button size="icon" variant="ghost" className="h-8 w-8" onClick={() => { setEditIndex(i); setEditValue(String(item)) }}>
                              <Pencil className="h-4 w-4" />
                            </Button>
                          )}
                          <Button size="icon" variant="ghost" className="h-8 w-8 text-primary" onClick={() => void removeMasterItem(i)}>
                            <Trash2 className="h-4 w-4" />
                          </Button>
                        </div>
                      </>
